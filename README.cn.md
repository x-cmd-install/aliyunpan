...
![aliyunpan](https://repo.x-cmd.io/aliyunpan.svg?lang=zh)
...
合计: **19,907** 行代码（覆盖前 5 种语言、共 **156** 个文件）。
...
- **上游仓库**: <https://github.com/tickstep/aliyunpan>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v0.4.0` (2026-06-29)
- **最近提交**: 2026-09-07
- **Release 含资产**: 26 个

## 流行度

- **Star**: 5,107 · **Fork**: 396 · **开放 issue**: 525 · **贡献者**: 8

## 累计统计

- **发布数**: 40 · **已合并 PR**: 9 · **开放 PR**: 0 · **已关闭 issue**: 505 · **开放 issue**: 20 · **提交数**: 672
...
| last60d | 2026-07-14 | 0 | 1 | 0 | 1 | 1 | 1 |
| 90d | 2026-06-14 | 1 | 1 | 0 | 3 | 2 | 5 |
| last180d | 2026-03-16 | 2 | 1 | 0 | 8 | 5 | 8 |
| 360d | 2025-09-17 | 3 | 3 | 0 | 20 | 9 | 37 |
| last720d | 2024-09-22 | 6 | 4 | 0 | 72 | 15 | 107 |
...
在 [repology.org](https://repology.org/project/aliyunpan) 上共有 **4** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**1** 个 ⚠️ 使用旧版本。
...
aliyunpan 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `aliyunpan` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/aliyunpan.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T04:34:17Z._
